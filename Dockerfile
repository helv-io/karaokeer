...
RUN apt update && apt -y install ffmpeg zlib1g-dev wget python3 python3-pip dos2unix git automake autoconf unzip sox gfortran libtool subversion nodejs npm
RUN npm install
RUN npx tsc
